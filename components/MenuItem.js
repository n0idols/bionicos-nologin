  ...
  return (
    <div key={item.id}>
      <a
        ...
        className="card lg:card-side bordered bg-white cursor-pointer md:hover:shadow-lg transition ease-linear md:hover:-translate-y-1"
      >
      ...
      >
        <div className="min-h-[200px] flex flex-col justify-between my-2 px-4">
